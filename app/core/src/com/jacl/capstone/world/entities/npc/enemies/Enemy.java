...
{	
	public Enemy(World world, float x, float y, boolean knockback_on_collide, float move_speed, float health, float damage_on_bump, Alignment alignment, AI ai)
	{
		super(world, x, y, knockback_on_collide, move_speed, health, damage_on_bump, Alignment.ENEMY, ai);
		ai.init(this);
	}
}
